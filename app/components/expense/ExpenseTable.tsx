            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 truncate text-xs text-gray-500">
                      {getMemberDisplayName(expense.userId)}
                    </p>
                  </div>
                  <p className="shrink-0 text-right text-base font-semibold tabular-nums text-rose-600">
                    {formatCurrency(expense.amount)}
                  </p>
                </div>
                ...
                <div className="mt-3 flex items-center justify-end gap-2 border-t border-gray-100 pt-3">
                  <button
                    type="button"
                    onClick={() => canModify && handleOpenEditModal(expense)}
                    disabled={!canModify}
                    className={
                      canModify
                        ? "inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900"
